...
- 各記事に開示文が入っていることを確認してください。Amazon規約で必須です
  - Amazon・楽天どちらの商品比較記事も「本記事はAmazonアソシエイト・プログラムを含むアフィリエイトプログラムを利用して商品を紹介しています。」で統一しています(2026-09-16〜)。Amazonアソシエイト規約が開示文中に"Amazon"の明記を求めるため、楽天のみの記事でもこの文言を使用しています
  - 新しい記事を追加するときも、この文言をそのまま使ってください
